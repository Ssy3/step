...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.initiative.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.initiatives.update", [$initiative->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $initiative->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id" required>
                    @foreach($projects as $id => $project)
                        <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $initiative->project->id ?? '') == $id ? 'selected' : '' }}>{{ $project }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('kpi_description') ? 'is-invalid' : '' }}" name="kpi_description" id="kpi_description">{!! old('kpi_description', $initiative->kpi_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('kpi_previous_date') ? 'is-invalid' : '' }}" type="text" name="kpi_previous_date" id="kpi_previous_date" value="{{ old('kpi_previous_date', $initiative->kpi_previous_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kpi_current') ? 'is-invalid' : '' }}" type="text" name="kpi_current" id="kpi_current" value="{{ old('kpi_current', $initiative->kpi_current) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('kpi_current_date') ? 'is-invalid' : '' }}" type="text" name="kpi_current_date" id="kpi_current_date" value="{{ old('kpi_current_date', $initiative->kpi_current_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('kpi_target_date') ? 'is-invalid' : '' }}" type="text" name="kpi_target_date" id="kpi_target_date" value="{{ old('kpi_target_date', $initiative->kpi_target_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('why_if_not_accomplished') ? 'is-invalid' : '' }}" name="why_if_not_accomplished" id="why_if_not_accomplished">{!! old('why_if_not_accomplished', $initiative->why_if_not_accomplished) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('users') ? 'is-invalid' : '' }}" name="users[]" id="users" multiple>
                    @foreach($users as $id => $user)
                        <option value="{{ $id }}" {{ (in_array($id, old('users', [])) || $initiative->users->contains($id)) ? 'selected' : '' }}>{{ $user }}</option>
                    @endforeach
                </select>
                @if($errors->has('users'))
                    <div class="invalid-feedback">
